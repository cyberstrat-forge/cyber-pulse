...
class TestRSSConnectorContentHash:
    ...
    def test_content_hash_consistency(self):
        ...
        hash1 = connector.generate_content_hash("test content")
        hash2 = connector.generate_content_hash("test content")
    ...
    def test_content_hash_different_content(self):
        ...
        hash1 = connector.generate_content_hash("content one")
        hash2 = connector.generate_content_hash("content two")
