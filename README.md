...
# 安装指定版本
curl -fsSL https://raw.githubusercontent.com/cyberstrat-forge/cyber-pulse/main/install.sh | bash -s -- --version v1.4.0
```
...
| 文档 | 说明 |
|------|------|
| [技术规格说明书](./docs/superpowers/specs/2026-03-18-cyber-pulse-design.md) | 系统架构设计 |
| [API 设计文档](./docs/superpowers/specs/2026-03-25-api-design.md) | API 端点设计 |
